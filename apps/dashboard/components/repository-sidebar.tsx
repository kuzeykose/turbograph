...
import { Folder, Clock, BarChart3, Menu } from "@workspace/ui/icons";
  ...
  return (
    <>
      ...
      <div className="hidden lg:block group relative h-full">
        ...
        <aside className="w-12 flex-shrink-0 flex flex-col border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 h-full group-hover:opacity-0 transition-opacity duration-200">
          <SidebarNavCollapsed
            items={navItems}
            activeTab={activeTab}
        ...
        <aside className="absolute left-0 top-0 w-48 flex flex-col border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 h-full shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-200 z-10">
          <SidebarNavExpanded
            items={navItems}
            activeTab={activeTab}
            onTabChange={setActiveTab}
